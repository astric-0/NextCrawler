...
class Weaver {
    ...
    getUpload() { return this.invariants?.upload }
    ...
    weave() {
        ...
        const { intervalRequestLimit, maxHostLimit, linkLimit, uploadUrl } = this.invariants;
        ...
        this.interval = setInterval(_ => {            
            ...
            urls.forEach(async url => {
                ...
                if (urlIdCounter >= linkLimit && this.getState() == weaverStates.active) {
                    this.stop();
                    ...
                    if (this.getUpload() && uploadUrl) {                        
                        ...
                        */
                        fetch(uploadUrl, {
                            ...
                            body: JSON.stringify({ url, htmlBody: body, links: urls }),
                        })
                        .catch(error=>{});
                    }
