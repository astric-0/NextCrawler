class Oracle {
    ...
    setProcessed(url, targetDir, info) {
        if (!(url && info)) return;
    ...
    roll() {
        ...
        return Object.keys(this.currentUrls) != 0;
    }

    getProcessed() { return Object.keys(this.processed).length; }
    ...
    getWaiting() { return Object.keys(this.waiting).length; }
