	...
	return (
		<Card text="primary" className="shadow mt-3">
			...
			<Card.Body align="justify">
				...
				<span className="fw-bold">Next.js</span> as a base framework and
				some required libraries to function.
				<br />
				<br />
				...
				<span className="fw-bold">
					...
					structure to perform crawling and collecting targeted data
					through web
				</span>
				. The app does that by providing modules to target different
				types of content. Also, A user can easily implement their own
				modules as project is open source and fundamentally structured
				to extend.
			</Card.Body>
		</Card>
	);
